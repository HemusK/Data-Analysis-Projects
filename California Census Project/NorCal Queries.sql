...
DROP TEMPORARY TABLE GreaterBay ;
CREATE TEMPORARY TABLE GreaterBay (county VARCHAR(255) ) ;
INSERT INTO GreaterBay
VALUES ("San Francisco County"), ("Alameda County"), ("Contra Costa County"), ("San Mateo County"), ("Marin County"), ("Sonoma County"), ("Solano County"), ("Napa County"), ("Santa Clara County");
...
HAVING workplace_county IN (SELECT * from GreaterBay) AND residence_county IN (SELECT * from GreaterBay)
